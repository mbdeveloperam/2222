...
local json = (loadfile "/home/root/2222/JSON.lua")()
local token = '414446252:AAEb9CkB4BmVX5y2QloWeJWmbDk4wxrBlNE' --token
local url = 'https://api.telegram.org/bot' .. token
local offset = 0
local redis = require('redis')
local redis = redis.connect('127.0.0.1', 6379)
local SUDO = 343615031
        ...
        for i=1, #updates.result do
          ...
          if msg.inline_query then
            local q = msg.inline_query
						if q.from.id == 401211182 or q.from.id == 343615031 then
